...
# Kitabi Duniya, a famous heritage bookstore, has seen its annual growth collapse 
# due to online selling and widespread internet access. 
# As a Data Scientist, the goal is to help gain its popularity back, increase customer 
# footfall, and improve business exponentially to an expected value of 25% improvement.

# Objective(s): Maximize sales revenue and increase customer footfall by 25%.
#
# Constraint(s): Physical space limitations for displays; must be adaptable to online stores.

# Success Criteria
#
# - Business Success Criteria: Achieve a 25% increase in total book sales and customer footfall.
#
# - ML Success Criteria: Discover strong, actionable association rules with Lift > 1 and high confidence.
#                        Performance/Speed: Complete processing within 5 mins on data.
#
# - Economic Success Criteria: The cost of implementing new layouts or promotional strategies 
#                              must be lower than the gross margin gained from the sales increase.

# HLD - DAR - DLD 

# Proposed Plan:
# Identify the Association between the different categories of books being purchased by the customers.

# Data Collection: Data Sources -> Data Collection -> Data Storage (DB, DWH, Data Lake, DLH)
